...
<body>
	<header>
		<h2 class="title"  style="color:#fff; padding: 10px;"></h2>
	</header>
      <h1><marquee>WELCOME To Happy shopping!!!!!!</marquee></h1>

<div style="width: 30%;margin: 0 auto">
<div class="des">
   
Our web page is basically a e-commarce site.Our journey starts since 2018. We try to make your life more comfortable and easy.An online platform where you can find and  order products within reasonable price.We will serve you with our best.
<div>
</body>